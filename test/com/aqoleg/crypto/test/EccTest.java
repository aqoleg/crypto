...
class EccTest {
    ...
    private void getEcc() {
        ...
        System.out.println("getEcc() " + (functionResult ? "ok" : "not ok"));
    }

    private void inOutPoint() {
        functionResult = true;
        Ecc eccA = Ecc.getEcc(
        ...
        testResult &= functionResult;
        System.out.println("inOutPoint() " + (functionResult ? "ok" : "not ok"));
    }
    ...
    private void xPoint() {
        ...
        testResult &= functionResult;
        System.out.println("xPoint() " + (functionResult ? "ok" : "not ok"));
    }

    private void gMultiply() {
        functionResult = true;
        ...
        testResult &= functionResult;
        System.out.println("gMultiply() " + (functionResult ? "ok" : "not ok"));
    }
    ...
    private void signVerifyTest() {
        ...
        Ecc curveA = Ecc.getEcc(a, b, p);
        assertThrows(Ecc.Exception.class, () -> curveA.sign(message, privateKey));
        assertFalse(curveA.verify(message, publicKey, signature));
        testResult &= functionResult;
        System.out.println("signVerifyTest() " + (functionResult ? "ok" : "not ok"));
    }
    ...
    private void verify() {
        ...
        message = hexToBytes("4b688df40bcedbe641ddb16ff0a1842d9c67ea1c3bf63f3e0471baa664531d1a");
        ...
        assertTrue(Ecc.secp256k1.verify(message, publicKey, signature));
        testResult &= functionResult;
        System.out.println("verify() " + (functionResult ? "ok" : "not ok"));
    }
